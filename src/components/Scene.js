...
const WebsiteDesignSection = lazy(() => import("./Moon"));
  ...
  return (
    <>
      ...
      <a
        ...
        className="fixed bottom-6 right-6 z-50 bg-[#333333] hover:bg-[#05204a] text-white rounded-full p-4 shadow-lg transition-all duration-300 hover:scale-110"
        style={{
          width: '60px',
          height: '60px',
          display: 'flex',
