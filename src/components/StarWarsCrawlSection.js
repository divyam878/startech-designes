...
export default function StarWarsCrawlSection() {
  ...
  return (
    <div ref={sectionRef} className="star-wars-crawl h-screen flex items-center justify-center">
      <div className="crawl-text text-yellow-500 text-center">
        <h2 className="text-5xl font-bold mb-4 text-white" style={{ fontFamily: 'Tomorrow-Bold' }}>A little about me.</h2>
        <p className="text-xl mb-4" style={{ color: '#e2e2e2', fontFamily: 'Tomorrow' }}>
        ...
        <p className="text-5xl" style={{ color: '#3e34f4', fontFamily: 'Tomorrow-Bold' }}>
